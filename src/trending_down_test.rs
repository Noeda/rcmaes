/* 10 March 2025: This file was originally in a project called "mj-lstm".
 * I (Mikko) copied it from there to not introduce a dependency to mj-lstm.
 *
 * I probably should figure out which packages I want things to live in general.
 *
 * ---
 *
 * 10 March 2025:
 * This file implements series_is_trending_down_XXX() family of functions that implement a
 * statistical test if a line is trending down. I originally saw it in a blog post, I think in
 * DLib, but I cannot for the life of me remember anymore exactly.
 *
 * I introduced it here to use in Cosyne to detect if sigma (i.e. learning rate) should be
 * bumped up or down.
 *
 * - Mikko
 */
