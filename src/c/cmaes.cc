...
extern "C" {
    void cmaes_optimize(int noisy, int elitism_reevaluate, int use_elitism, int use_surrogates, int algo, double* initial, double sigma, int lambda, uint64_t num_coords, double (*evaluate)(double*, int*, void*), void (*iterator)(void*), void* userdata);
}
...
void cmaes_optimize(int noisy, int elitism_reevaluate, int use_elitism, int use_surrogates, int algo, double* initial, double sigma, int lambda, uint64_t num_coords, double (*evaluate)(double*, int*, void*), void (*iter)(void*), void* userdata)
{
